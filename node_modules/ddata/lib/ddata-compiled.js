...
function isEnum() {
  return this.isEnum || this.kind === 'enum';
}
function isExternal() {
...
function anchorName(options) {
  ...
  return util.format('%s%s%s', this.isExported ? 'exp_' : '', this.kind === 'constructor' ? 'new_' : '', this.id.replace(/:/g, '_').replace(/~/g, '..').replace(/\(\)/g, '_new').replace(/#/g, '+'));
}
...
//# sourceMappingURL=ddata-compiled.js.map